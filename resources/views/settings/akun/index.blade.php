            ...
            <div class="flex-1 overflow-auto">
                <div class="max-w-7xl mx-auto px-8 py-8">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('akun.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200 flex items-center gap-2">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse ($akuns as $akun)
                                        <tr class="hover:bg-gray-50 transition duration-150">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $akun->kode_akun }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $akun->nama_akun }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex gap-2">
                                                <a href="{{ route('akun.edit', $akun->id) }}" class="text-blue-600 hover:text-blue-900 transition duration-200">
                                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                                ...
                                                <form action="{{ route('akun.destroy', $akun->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Yakin ingin menghapus?');">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                                ...
                                                <p class="text-lg font-medium">Tidak ada data Akun</p>
                                                <p class="text-sm">Mulai dengan membuat Akun baru</p>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
                        ...
                        @else
                            <div class="px-6 py-12 text-center">
                                ...
                                <p class="text-lg font-medium text-gray-900">Tidak ada data Akun</p>
                                <p class="text-sm text-gray-500">Mulai dengan membuat Akun baru</p>
                            </div>
                        @endif
                    </div>
                </div>
