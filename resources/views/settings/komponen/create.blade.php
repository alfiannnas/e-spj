...
<head>
    ...
    <title>Tambah Komponen - {{ config('app.name', 'Laravel') }}</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="bg-white shadow-sm border-b border-gray-200 px-8 py-4">
                <div class="flex items-center justify-between">
                    <h2 class="text-2xl font-bold text-gray-900">Tambah Komponen Baru</h2>
            ...
            <div class="flex-1 overflow-auto">
                <div class="max-w-2xl mx-auto px-8 py-8">
                    <!-- Back Button -->
                    <a href="{{ route('komponen.index') }}" class="flex items-center gap-2 text-blue-600 hover:text-blue-900 mb-6">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="bg-white rounded-lg shadow p-8">
                        <form action="{{ route('komponen.store') }}" method="POST">
                            ...
                            <!-- Kode Komponen -->
                            <div class="mb-6">
                                <label class="block text-gray-700 text-sm font-medium mb-2" for="kode_komponen">
                                    Kode Komponen
                                </label>
                                <input
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('kode_komponen') border-red-500 @enderror"
                                    id="kode_komponen"
                                    type="text"
                                    name="kode_komponen"
                                    value="{{ old('kode_komponen') }}"
                                    placeholder="Masukkan kode komponen (mis: KOMP001)"
                                    required
                                />
                                @error('kode_komponen')
                            ...
                            <!-- Nama Komponen -->
                            <div class="mb-6">
                                <label class="block text-gray-700 text-sm font-medium mb-2" for="nama_komponen">
                                    Nama Komponen
                                </label>
                                <input
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('nama_komponen') border-red-500 @enderror"
                                    id="nama_komponen"
                                    type="text"
                                    name="nama_komponen"
                            ...
                            <!-- RO -->
                            <div class="mb-6">
                                <label class="block text-gray-700 text-sm font-medium mb-2" for="ro_id">
                                    RO (Opsional)
                                </label>
                                <select
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('ro_id') border-red-500 @enderror"
                                    id="ro_id"
                                    name="ro_id"
                                >
                                    <option value="">-- Pilih RO --</option>
                                    @foreach($ros as $ro)
                                        <option value="{{ $ro->id }}" {{ old('ro_id') == $ro->id ? 'selected' : '' }}>
                            ...
                            <div class="flex gap-4">
                                ...
                                <a href="{{ route('komponen.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-6 rounded-lg transition duration-200">
                                    Batal
                                </a>
                            </div>
                        </form>
