...
<head>
    ...
    <title>Edit Komponen - {{ config('app.name', 'Laravel') }}</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="bg-white shadow-sm border-b border-gray-200 px-8 py-4">
                <div class="flex items-center justify-between">
                    <h2 class="text-2xl font-bold text-gray-900">Edit Komponen</h2>
                        ...
                        <form action="{{ route('komponen.update', $komponen->id) }}" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                >
                                    ...
                                    @foreach($ros as $ro)
                                        <option value="{{ $ro->id }}" {{ old('ro_id', $komponen->ro_id) == $ro->id ? 'selected' : '' }}>
