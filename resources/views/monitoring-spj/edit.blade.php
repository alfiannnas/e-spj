...
<head>
    ...
    <title>Edit Monitoring SPJ - {{ config('app.name', 'Laravel') }}</title>
                    ...
                    <div class="bg-white rounded-xl shadow border border-gray-200 overflow-hidden">
                        <div class="overflow-x-auto">
                            <div class="max-w-5xl mx-auto">
                                ...
                                <!-- Header -->
                                <div class="mt-9 mb-6">
                                    <h2 class="text-2xl font-bold text-gray-900">Edit Monitoring SPJ</h2>
                                    <p class="text-sm text-gray-600">Ubah data monitoring SPJ dengan lengkap dan benar</p>
                                </div>

                                <!-- Form -->
                                <div class="bg-white rounded-xl shadow border border-gray-200 p-8 mx-auto mb-20">
                                    <form action="{{ route('monitoring-spj.update', ['monitoring_spj' => $monitoring_spj->id]) }}" method="POST" class="space-y-6">
                                        @csrf
                                        @method('PUT')
                                        <div class="grid grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <input type="date" name="submitted_at"
                                                    value="{{ old('submitted_at', $monitoring_spj->submitted_at?->format('Y-m-d')) }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="date" name="activity_date"
                                                    value="{{ old('activity_date', $monitoring_spj->activity_date?->format('Y-m-d')) }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="division"
                                                    value="{{ old('division', $monitoring_spj->division) }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="mak_number"
                                                    value="{{ old('mak_number', $monitoring_spj->mak_number) }}"
                                            ...
                                            <div class="col-span-2">
                                                ...
                                                <input type="text" name="activity_name"
                                                    value="{{ old('activity_name', $monitoring_spj->activity_name) }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="number" name="rab"
                                                    value="{{ old('rab', $monitoring_spj->rab) }}" min="0" step="1"
                                            ...
                                            <div>
                                                ...
                                                <input type="number" name="realization"
                                                    value="{{ old('realization', $monitoring_spj->realization) }}" min="0" step="1"
                                            ...
                                            <div class="col-span-2">
                                                ...
                                                <textarea name="notes" rows="3"
                                                    ...
                                                    placeholder="Catatan (opsional)">{{ old('notes', $monitoring_spj->notes) }}</textarea>
                                                @error('notes')
                                                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                                @enderror
                                            </div>
