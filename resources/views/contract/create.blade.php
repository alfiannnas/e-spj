...
<head>
    ...
    <title>Tambah Kontrak - {{ config('app.name', 'Laravel') }}</title>
                    ...
                    <div class="bg-white rounded-xl shadow border border-gray-200 overflow-hidden">
                        <div class="overflow-x-auto">
                            <div class="max-w-5xl mx-auto">
                                ...
                                <!-- Header -->
                                <div class="mt-9 mb-6">
                                    <h2 class="text-2xl font-bold text-gray-900">Tambah Kontrak</h2>
                                    <p class="text-sm text-gray-600">Isi data kontrak dengan lengkap dan benar</p>
                                </div>

                                <!-- Form -->
                                <div class="bg-white rounded-xl shadow border border-gray-200 p-8 mx-auto mb-20 ">
                                    <form action="{{ route('contract.store') }}" method="POST" class="space-y-6">
                                        @csrf
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <input type="date" name="tanggal_sp" value="{{ old('tanggal_sp') }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="nama_pejabat_penandatangan" value="{{ old('nama_pejabat_penandatangan') }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="nama_penyedia" value="{{ old('nama_penyedia') }}"
                                            ...
                                            <div class="md:col-span-2">
                                                ...
                                                <input type="text" name="nama_paket_pengadaan" value="{{ old('nama_paket_pengadaan') }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="date" name="waktu_pelaksanaan" value="{{ old('waktu_pelaksanaan') }}"
