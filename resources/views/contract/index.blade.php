...
<head>
    ...
    <title>Manajemen Kontrak - {{ config('app.name', 'Laravel') }}</title>
            ...
            <div class="flex-1 overflow-auto">
                <div class="max-w-8xl mx-auto px-8 py-8">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-xl font-bold text-gray-900">Daftar Kontrak</h3>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600 uppercase">Satuan Kerja</th>
                                        <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600 uppercase">Tanggal SP</th>
                                        <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600 uppercase">Pejabat Penandatangan</th>
                                        <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600 uppercase">Nama Penyedia</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 text-sm font-medium text-gray-900">
                                            {{ $contract->satuan_kerja }}
                                        </td>
                                        <td class="px-4 py-3 text-sm text-gray-700">
                                            {{ \Carbon\Carbon::parse($contract->tanggal_sp)->format('d-m-Y') }}
                                        </td>
                                        <td class="px-4 py-3 text-sm text-gray-700">
                                            {{ $contract->nama_pejabat_penandatangan }}
                                        </td>
                                        <td class="px-4 py-3 text-sm text-gray-700">
                                            {{ $contract->nama_penyedia }}
                                        </td>
                                        <td class="px-4 py-3 text-sm text-gray-700">
                                            {{ $contract->nama_paket_pengadaan }}
                                        </td>
                                        <td class="px-4 py-3 text-sm text-gray-700">
                                            {{ $contract->sumber_dana }}
                                        </td>
                                        <td class="px-4 py-3 text-sm text-gray-700">
                                            {{ \Carbon\Carbon::parse($contract->waktu_pelaksanaan)->format('d-m-Y') }}
                                        </td>
